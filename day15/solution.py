...
def run_dijkstra(graph, start_vertex) -> dict[int, float]:
    dijkstra: dict[int, float] = {
...
def read_risk_map(lines: list[str]) -> tuple[list[list[Risk]], int]:
    risk_map = []
...
def read_risk_graph(risk_map: list[list[Risk]], size: int) -> Graph:
