...
def read_input_and_output_values(
    filename: str,
...
def patterns_for_easy_digits(
    ...
    patterns_by_digit: dict[int, str] = {}
    for segment_count, digit in easy_digits_by_segment_count.items():
        patterns_by_digit[digit] = patterns_by_segment_count.pop(segment_count)[0]

    return patterns_by_digit
...
def find_5(patterns_by_segment_count: dict[int, list[str]], pattern_for_4: str) -> str:
    return find_number(patterns_by_segment_count[5], pattern_for_4, 3)


def find_9(patterns_by_segment_count: dict[int, list[str]], pattern_for_3: str) -> str:
    return find_number(patterns_by_segment_count[6], pattern_for_3, 1)


def find_6(patterns_by_segment_count: dict[int, list[str]], pattern_for_5: str) -> str:
    return find_number(patterns_by_segment_count[6], pattern_for_5, 1)
...
def get_patterns_for_digits(
    ...
    easy = patterns_for_easy_digits(patterns_by_segment_count)
    pattern_3 = find_3(patterns_by_segment_count)
    pattern_5 = find_5(patterns_by_segment_count, easy[4])
    pattern_2 = patterns_by_segment_count.pop(5)[0]
    pattern_9 = find_9(patterns_by_segment_count, pattern_3)
    pattern_6 = find_6(patterns_by_segment_count, pattern_5)
    pattern_0 = patterns_by_segment_count.pop(6)[0]

    patterns_by_digits: list[str | None] = [None] * 10
    for digit, pattern in easy.items():
        patterns_by_digits[digit] = pattern
    patterns_by_digits[0] = pattern_0
    patterns_by_digits[2] = pattern_2
    patterns_by_digits[3] = pattern_3
    patterns_by_digits[5] = pattern_5
    patterns_by_digits[6] = pattern_6
    patterns_by_digits[9] = pattern_9
    return patterns_by_digits


def decode(patterns: list[str], patterns_for_digits: list[str | None]) -> int:
    decoded = ""
    for pattern in patterns:
